<div class="antialiased">
    ...
    <section 
        ...
        <img src="/images/airterjunpupuanblemantung.webp" 
        ...
        <div class="relative z-10 px-6" data-aos="fade-up" data-aos-delay="300">
            ...
            <p class="text-sm md:text-lg max-w-3xl mx-auto leading-relaxed text-gray-100 px-0 md:px-10" data-aos="fade-up" data-aos-delay="1000">
                {{ $texts['blematung_header_subtitle'] }}
            </p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="100">
                    <i class="fas fa-mountain text-3xl md:text-4xl text-primary mb-4 block"></i> {{-- ROTATE DIHAPUS --}}
                    <h3 class="font-semibold text-lg mb-2">{{ $texts['special_1_title'] }}</h3>
                    <p class="text-gray-600 text-sm">{{ $texts['special_1_desc'] }}</p>
                </div>
                ...
                <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="200">
                    <i class="fas fa-coffee text-3xl md:text-4xl text-primary mb-4 block"></i> {{-- ROTATE DIHAPUS --}}
                    <h3 class="font-semibold text-lg mb-2">{{ $texts['special_2_title'] }}</h3>
                    <p class="text-gray-600 text-sm">{{ $texts['special_2_desc'] }}</p>
                </div>
                ...
                <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="300">
                    <i class="fas fa-snowflake text-3xl md:text-4xl text-primary mb-4 block"></i> {{-- ROTATE DIHAPUS --}}
                    <h3 class="font-semibold text-lg mb-2">{{ $texts['special_3_title'] }}</h3>
                    <p class="text-gray-600 text-sm">{{ $texts['special_3_desc'] }}</p>
                </div>
                ...
                <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="400">
                    <i class="fas fa-water text-3xl md:text-4xl text-primary mb-4 block"></i> {{-- ROTATE DIHAPUS --}}
                    <h3 class="font-semibold text-lg mb-2">{{ $texts['special_4_title'] }}</h3>
                    <p class="text-gray-600 text-sm">{{ $texts['special_4_desc'] }}</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <ul class="space-y-4"> {{-- Menaikkan space-y untuk menampung elemen vertikal --}}
                            ...
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-shoe-prints text-xl text-primary mr-3"></i> 
                                    <span class="font-bold text-gray-800 text-lg">{{ $texts['trekking_difficulty_title'] }}</span> 
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">{{ $texts['trekking_difficulty_desc'] }}</span>
                            </li>
                            
                            {{-- ITEM 2: WAKTU TEMPUH (Vertical Layout) --}}
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-clock text-xl text-primary mr-3"></i> 
                                    <span class="font-bold text-gray-800 text-lg">{{ $texts['trekking_time_title'] }}</span> 
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">{{ $texts['trekking_time_desc'] }}</span>
                            </li>
                            
                            {{-- ITEM 3: PEMANDANGAN (Vertical Layout) --}}
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-tree text-xl text-primary mr-3"></i> 
                                    <span class="font-bold text-gray-800 text-lg">{{ $texts['trekking_view_title'] }}</span> 
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['trekking_view_desc'] }}
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="w-full md:w-1/2 p-6  rounded-none md:rounded-2xl bg-white" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        ...
                        <h3 class="text-xl font-bold text-gray-800">{{ $texts['persiapan_wajib_title'] }}</h3>
                    </div>
                    ...
                    <ul class="space-y-4 text-gray-700 p-4 border border-gray-100 rounded-lg">
                        <li class="flex items-start">
                            ...
                            <i class="fas fa-hikingt text-xl text-primary mr-3"></i> 
                            {{ $texts['wajib_1_desc'] }}
                        </li>
                        <li class="flex items-start">
                        
                            <i class="fas fa-tshirt text-xl text-primary mr-3"></i> 
                            {{ $texts['wajib_2_desc'] }}
                        </li>
                        <li class="flex items-start">
