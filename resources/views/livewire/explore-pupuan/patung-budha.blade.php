<div class="antialiased">
    ...
    <section 
        ...
        <img src="/images/headerexplorepupuan.webp" 
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="font-semibold text-lg mb-2">{{ $texts['vihara_poin1_title'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['vihara_poin1_desc'] }}</p>
            </div>
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="200">
                <i class="fas fa-bed text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['vihara_poin2_title'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['vihara_poin2_desc'] }}</p>
            </div>
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="300">
                <i class="fas fa-tree text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['vihara_poin3_title'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['vihara_poin3_desc'] }}</p>
            </div>
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="400">
                <i class="fas fa-users text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['vihara_poin4_title'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['vihara_poin4_desc'] }}</p>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0 items-start">
                ...
                <div class="w-full md:w-1/2 p-6 rounded-none md:rounded-2xl bg-white" data-aos="fade-right">
                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        <i class="fas fa-map-marked-alt text-3xl text-primary mr-4"></i>
                        <h3 class="text-xl font-bold text-gray-800">{{ $texts['akses_judul'] }}</h3>
                    </div>

                    <p class="text-sm md:text-lg text-gray-600 leading-relaxed mb-6">
                        {{ $texts['akses_deskripsi'] }}
                    </p>
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-location-arrow text-xl text-primary mr-3"></i>
                                    <span class="font-bold text-gray-800 text-lg">{{ $texts['lokasi_tepat'] }}</span>
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['lokasi_tepat_desc'] }}
                                </span>
                            </li>
                            ...
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    ...
                                    <span class="font-bold text-gray-800 text-lg">{{ $texts['petunjuk_arah'] }}</span>
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['petunjuk_arah_desc'] }}
                                </span>
                            </li>

                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-eye text-xl text-primary mr-3"></i>
                                    <span class="font-bold text-gray-800 text-lg">{{ $texts['dapat_dilihat'] }}</span>
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['dapat_dilihat_desc'] }}
                                </span>
                            </li>
                ...
                {{-- 2. KARTU ETIKA PENGUNJUNG --}}
                <div class="w-full md:w-1/2 p-6 rounded-none md:rounded-2xl bg-white"
                     data-aos="fade-right" data-aos-delay="200">

                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        <i class="fas fa-praying-hands text-3xl text-primary mr-4"></i>
                        <h3 class="text-xl font-bold text-gray-800">{{ $texts['etika_judul'] }}</h3>
                    </div>
                    ...
                    <ul class="space-y-4 text-gray-700 p-4 border border-gray-100 rounded-lg">
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-volume-mute text-xl text-primary mr-3"></i>
                            {{ $texts['etika2'] }}
                        </li>

                        <li class="flex items-start">
                            <i class="fas fa-users text-xl text-primary mr-3"></i>
                            {{ $texts['etika3'] }}
                        </li>
