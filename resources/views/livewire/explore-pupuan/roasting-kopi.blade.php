<div class="antialiased">
    <section 
        ...
        <img src="/images/kopipupuan.webp" 
        ...
        <div class="relative z-10 px-6" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="w-24 h-1 bg-white mx-auto mb-6 rounded-full"
    ...
    <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="100">
        <i class="fas fa-hand-holding-heart text-3xl md:text-4xl text-primary mb-4 block"></i>
        <h3 class="font-semibold text-lg mb-2">{{ $texts['kopi_poin1_judul'] }}</h3>
        <p class="text-gray-600 text-sm">{{ $texts['kopi_poin1_desc'] }}</p>
    </div>
    ...
    <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="200">
        <i class="fas fa-coffee text-3xl md:text-4xl text-primary mb-4 block"></i>
        <h3 class="font-semibold text-lg mb-2">{{ $texts['kopi_poin2_judul'] }}</h3>
        <p class="text-gray-600 text-sm">{{ $texts['kopi_poin2_desc'] }}</p>
    </div>
    ...
    <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="300">
        <i class="fas fa-fire text-3xl md:text-4xl text-primary mb-4 block"></i>
        <h3 class="font-semibold text-lg mb-2">{{ $texts['kopi_poin3_judul'] }}</h3>
        <p class="text-gray-600 text-sm">{{ $texts['kopi_poin3_desc'] }}</p>
    </div>
    ...
    <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="400">
        <i class="fas fa-award text-3xl md:text-4xl text-primary mb-4 block"></i>
        <h3 class="font-semibold text-lg mb-2">{{ $texts['kopi_poin4_judul'] }}</h3>
        <p class="text-gray-600 text-sm">{{ $texts['kopi_poin4_desc'] }}</p>
    </div>
            ...
            <div class="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0 items-start">
                ...
                <div class="w-full md:w-1/2 p-6 rounded-none md:rounded-2xl bg-white" data-aos="fade-right">
                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        <i class="fas fa-tractor text-3xl text-primary mr-4"></i>
                        <h3 class="text-xl font-bold text-gray-800">
                            {{ $texts['kopi_panen_judul'] }}
                        </h3>
                    </div>

                    <p class="text-sm md:text-lg text-gray-600 leading-relaxed mb-6">
                        {{ $texts['kopi_panen_desc'] }}
                    </p>
                        ...
                        <ul class="space-y-4">
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-hand-holding text-xl text-primary mr-3"></i>
                                    <span class="font-bold text-gray-800 text-lg">
                                        {{ $texts['kopi_pemetikan_judul'] }}
                                    </span>
                                </div>
                                <span class="ml-0 md:ml-8 text-gray-600">
                                    {{ $texts['kopi_pemetikan_desc'] }}
                                </span>
                            </li>
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    ...
                                    <span class="font-bold text-gray-800 text-lg">
                                        {{ $texts['kopi_penjemuran_judul'] }}
                                    </span>
                                </div>
                                <span class="ml-0 md:ml-8 text-gray-600">
                                    {{ $texts['kopi_penjemuran_desc'] }}
                                </span>
                            </li>
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-wind text-xl text-primary mr-3"></i>
                                    <span class="font-bold text-gray-800 text-lg">
                                        {{ $texts['kopi_pengeringan_judul'] }}
                                    </span>
                                </div>
                                <span class="ml-0 md:ml-8 text-gray-600">
                                    {{ $texts['kopi_pengeringan_desc'] }}
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- KARTU 2: Roasting & Tasting -->
                <div class="w-full md:w-1/2 p-6 rounded-none md:rounded-2xl bg-white" data-aos="fade-right" data-aos-delay="200">
                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        <i class="fas fa-sync-alt text-3xl text-primary mr-4"></i>
                        <h3 class="text-xl font-bold text-gray-800">
                            {{ $texts['kopi_roasting_judul'] }}
                        </h3>
                    </div>

                    <ul class="space-y-4 text-gray-700 p-4 border border-gray-100 rounded-lg">
                        <li class="flex items-start">
                            <i class="fas fa-thermometer-three-quarters text-xl text-primary mr-3"></i>
                            {{ $texts['kopi_roasting_poin1'] }}
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-balance-scale text-xl text-primary mr-3"></i>
                            {{ $texts['kopi_roasting_poin2'] }}
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-utensils text-xl text-primary mr-3"></i>
                            {{ $texts['kopi_roasting_poin3'] }}
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-shopping-bag text-xl text-primary mr-3"></i>
                            {{ $texts['kopi_roasting_poin4'] }}
                        </li>
                    </ul>
                </div>
