<div class="antialiased">
    ...
    <section 
        ...
        <img src="/images/gulaarenpupuan.jpg" 
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="100">
                <i class="fas fa-hammer text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['gula_poin1_judul'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['gula_poin1_text'] }}</p>
            </div>
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="200">
                <i class="fas fa-feather-alt text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['gula_poin2_judul'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['gula_poin2_text'] }}</p>
            </div>
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="300">
                <i class="fas fa-utensils text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['gula_poin3_judul'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['gula_poin3_text'] }}</p>
            </div>
            ...
            <div class="p-8 bg-white rounded-3xl shadow-xl transition duration-500 transform hover:scale-[1.02] hover:shadow-primary/30" data-aos="fade-up" data-aos-delay="400">
                <i class="fas fa-box-open text-3xl md:text-4xl text-primary mb-4 block"></i>
                <h3 class="font-semibold text-lg mb-2">{{ $texts['gula_poin4_judul'] }}</h3>
                <p class="text-gray-600 text-sm">{{ $texts['gula_poin4_text'] }}</p>
            </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto p-0 md:p-8 rounded-none md:rounded-3xl bg-white">
            ...
            <h2 class="text-2xl md:text-4xl font-extrabold text-secondary leading-snug mb-6 text-center" data-aos="fade-up">
                {!! $texts['gula_proses_section_title'] !!}
            </h2>
            ...
            <div class="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0 items-start">
                ...
                <div class="w-full md:w-1/2 p-6 rounded-none md:rounded-2xl bg-white" data-aos="fade-right">
                    ...
                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        <i class="fas fa-water text-3xl text-primary mr-4"></i>
                        <h3 class="text-xl font-bold text-gray-800">
                            {{ $texts['gula_proses1_title'] }}
                        </h3>
                    </div>
                    
                    <p class="text-sm md:text-lg text-gray-600 leading-relaxed mb-6">
                        {{ $texts['gula_proses1_desc'] }}
                    </p>
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    ...
                                    <span class="font-bold text-gray-800 text-lg">
                                        {{ $texts['gula_proses1_target_title'] }}
                                    </span>
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['gula_proses1_target_text'] }}
                                </span>
                            </li>

                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    <i class="fas fa-hand-point-right text-xl text-primary mr-3"></i>
                                    <span class="font-bold text-gray-800 text-lg">
                                        {{ $texts['gula_proses1_teknik_title'] }}
                                    </span>
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['gula_proses1_teknik_text'] }}
                                </span>
                            </li>
                            ...
                            <li class="flex flex-col items-start text-gray-700">
                                <div class="flex items-center mb-1">
                                    ...
                                    <span class="font-bold text-gray-800 text-lg">
                                        {{ $texts['gula_proses1_durasi_title'] }}
                                    </span>
                                </div>
                                <span class="ml-0 md:ml-8 font-normal text-gray-600">
                                    {{ $texts['gula_proses1_durasi_text'] }}
                                </span>
                            </li>
                ...
                <div class="w-full md:w-1/2 p-6 rounded-none md:rounded-2xl bg-white" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="flex items-center mb-5 border-b border-gray-100 pb-3">
                        <i class="fas fa-fire-alt text-3xl text-primary mr-4"></i>
                        <h3 class="text-xl font-bold text-gray-800">
                            {{ $texts['gula_proses2_title'] }}
                        </h3>
                    </div>
                    ...
                    <ul class="space-y-4 text-gray-700 p-4 border border-gray-100 rounded-lg">
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-thermometer-half text-xl text-primary mr-3"></i>
                            {{ $texts['gula_proses2_poin1'] }}
                        </li>
                        
                        <li class="flex items-start">
                            <i class="fas fa-plus text-xl text-primary mr-3"></i>
                            {{ $texts['gula_proses2_poin2'] }}
                        </li>
                        
                        <li class="flex items-start">
                            <i class="fas fa-fill-drip text-xl text-primary mr-3"></i>
                            {{ $texts['gula_proses2_poin3'] }}
                        </li>
                        
                        <li class="flex items-start">
                            <i class="fas fa-box text-xl text-primary mr-3"></i>
                            {{ $texts['gula_proses2_poin4'] }}
                        </li>
