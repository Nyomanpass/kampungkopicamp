<div class="min-h-screen bg-neutral">
    {{-- Hero Section --}}
    <section class="relative w-full h-[50vh] flex items-center justify-center text-center text-white overflow-hidden"
        ...
        <!-- Gradient Overlay -->
        <div class="absolute inset-0 bg-gradient-to-b from-dark-primary/80 via-primary/60 to-dark-primary/90"></div>
    ...
    {{-- Main Content --}}
    <div class="container max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-3 gap-10">
        ...
        <article class="lg:col-span-2">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8" data-aos="fade-up">
                <h3 class="text-lg font-bold text-dark-primary mb-4 flex items-center gap-2">
        ...
        <aside class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-6" data-aos="fade-up" data-aos-delay="200">
                <h2 class="text-2xl font-bold text-dark-primary mb-6 flex items-center gap-2">
