  ...
  <section class="relative w-full min-h-screen overflow-hidden">
      ...
      <div class="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div class="max-w-4xl mx-auto text-center text-white space-y-6 sm:space-y-8">
              ...
              <!-- Badge -->
              <span class="inline-block bg-accent/90 backdrop-blur-sm text-white text-xs sm:text-sm font-semibold px-4 sm:px-6 py-2 rounded-full shadow-lg"
              ...
              <!-- Subheadline -->
              <p class="text-base sm:text-lg md:text-xl text-gray-100 max-w-2xl mx-auto px-4"
      ...
      <!-- Scroll Indicator -->
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce" data-aos="fade-up" data-aos-delay="1200">
  ...
  <div class="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
      ...
      <div class="flex-1 w-full" data-aos="fade-right">
        ...
        <p class="text-sm sm:text-base text-gray-700 leading-relaxed mb-6 sm:mb-8" 
           data-aos="fade-up" data-aos-delay="400">
          {{ $texts['about_desc2'] }}
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-8" 
          ...
          <div class="flex items-start gap-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            <div class="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-full bg-primary/10">
          ...
          <div class="flex items-start gap-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            <div class="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-full bg-success/10">
      ...
      @foreach($pakets as $index => $paket)
        <div class="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden"
          ...
          <div class="relative overflow-hidden aspect-[4/3]">
            ...
            <!-- Overlay Badge -->
            <div class="absolute top-3 right-3 bg-primary/90 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1 rounded-full">
          ...
          <div class="p-4 sm:p-5">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
              ...
              @if($countOthers > 0)
                <span class="px-2 sm:px-3 py-1 bg-accent/10 text-accent text-xs rounded-full font-semibold">
            ...
            <div class="flex gap-2">
              ...
              <a href="{{ route('paket.detail', ['slug' => str(is_array($paket->title) ? $paket->title[$lang] : $paket->title)->slug()]) }}"
                 class="flex-shrink-0 px-4 py-2.5 bg-white border-2 border-primary text-primary text-sm font-semibold rounded-lg hover:bg-primary hover:text-white transition-all duration-300">
        ...
        <div class="space-y-3 mb-8">
          @foreach([
            ...
            <div class="flex items-start gap-3 p-3 sm:p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all" 
              ...
              <div class="flex-shrink-0 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary/10">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex flex-wrap items-center gap-2 mb-1">
                  ...
                  <span class="text-xs text-gray-500 bg-neutral px-2 py-0.5 rounded-full whitespace-nowrap">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
      @foreach ($blogs as $index => $blog)
        <article class="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden"
                 data-aos="fade-up"
          ...
          <a href="{{ route('article.detail', ['slug' => Str::slug($blog->title[$lang] ?? '')]) }}" 
            ...
            <!-- Category Badge -->
            <div class="absolute top-3 left-3 bg-primary/90 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1 rounded-full">
          ...
          <div class="p-4 sm:p-5">
            ...
            <!-- Title -->
            <h3 class="font-bold text-dark text-base sm:text-lg mb-2 line-clamp-2 min-h-[3rem] group-hover:text-primary transition-colors">
              <a href="{{ route('article.detail', ['slug' => Str::slug($blog->title[$lang] ?? '')]) }}">
                {{ $blog->title[$lang] ?? '' }}
              </a>
            </h3>
      ...
      <div class="space-y-4" data-aos="fade-right">
        ...
        <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow" 
          ...
          <div class="flex items-start gap-4">
            <div class="flex-shrink-0 flex items-center justify-center w-12 h-12 bg-success/10 rounded-full">
        ...
        <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow" 
             data-aos="fade-up" data-aos-delay="300">
          <div class="flex items-start gap-4">
            <div class="flex-shrink-0 flex items-center justify-center w-12 h-12 bg-danger/10 rounded-full">
