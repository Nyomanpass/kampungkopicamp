<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div class="bg-gradient-to-br from-info to-info/80 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-sm opacity-90 mb-1">Total Bookings</p>
        ...
        <div class="bg-gradient-to-br from-status-refunded to-status-refunded/80 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-sm opacity-90 mb-1">Conversion Rate</p>
        ...
        <div class="bg-gradient-to-br from-accent to-accent/80 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-sm opacity-90 mb-1">Avg Booking Value</p>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Total Value
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($upcomingBookings as $booking)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <p class="font-bold text-gray-900">Rp {{ number_format($booking->total_price) }}</p>
                            </td>
                            <td class="px-6 py-4">
