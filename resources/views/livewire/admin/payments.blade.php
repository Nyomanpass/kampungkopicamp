{{-- filepath: resources/views/livewire/admin/payments.blade.php --}}
<div class="space-y-6">
    ...
    @if ($viewMode === 'dashboard')
        @include('livewire.admin.payments.dashboard')
    @elseif ($viewMode === 'list')
        @include('livewire.admin.payments.list')
    @elseif ($viewMode === 'detail')
        @include('livewire.admin.payments.detail')
    @endif
</div>
