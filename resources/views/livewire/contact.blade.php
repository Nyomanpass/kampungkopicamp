<div>
    <section class="relative w-full h-[70vh] flex items-center justify-center text-center text-white overflow-hidden"
        ...
        <!-- Background Image -->
        <img src="/images/contactpupuan.webp" alt="Contact Background" class="absolute inset-0 w-full h-full object-cover"
        ...
        <div class="relative z-10 px-6" data-aos="fade-up" data-aos-delay="300">
            ...
            <h1 class="text-3xl md:text-5xl font-bold leading-tight mb-6" data-aos="fade-up" data-aos-delay="600">
                {{ $texts['contact_title_1'] }} <span class="text-secondary">{{ $texts['contact_title_2'] }}</span>
            </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-[1.02] flex flex-col justify-between"
                    ...
                    <div>
                        <div class="flex justify-center mb-5">
                            <span
                                class="w-14 h-14 flex items-center justify-center rounded-full bg-primary text-white text-2xl shadow-md">
                                <i class="fa-solid fa-phone"></i>
                            </span>
                        </div>
                        <h3 class="text-xl font-bold text-center mb-2 text-gray-800">{{ $texts['contact_phone_title'] }}
                        </h3>
                        <p class="text-gray-600 text-center font-medium mb-1">{{ $contactInfo['phone'] }}</p>
                    </div>
                    <div class="text-center mt-4">
                        <a href="https://wa.me/{{ $contactInfo['whatsapp'] }}" target="_blank"
                            class="w-full inline-flex items-center justify-center px-5 py-2.5 border border-secondary text-secondary font-semibold rounded-xl hover:bg-secondary hover:text-white transition">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-[1.02] flex flex-col justify-between"
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-center mb-2 text-gray-800">{{ $texts['contact_email_title'] }}
                        </h3>
                        <p class="text-gray-600 text-center font-medium mb-1 truncate">{{ $contactInfo['email'] }}</p>
                ...
                <div class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-[1.02] flex flex-col justify-between"
                    ...
                    <div>
                        ...
                        <h3 class="text-xl font-bold text-center mb-2 text-gray-800">
                            {{ $texts['contact_address_title'] }}</h3>
                        <p class="text-gray-600 text-center mb-4">
                            {{ $contactInfo['address'] }}
                        </p>
                    </div>
                    <div class="text-center mt-4">
                        <a href="hhttps://www.google.com/maps?ll=-8.342049,115.036913&z=14&t=m&hl=id&gl=ID&mapclient=embed&cid=9951410633565317211"
                            target="_blank"
                            class="w-full inline-flex items-center justify-center px-5 py-2.5 border border-secondary text-secondary font-semibold rounded-xl hover:bg-secondary hover:text-white transition">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition">
                            <div class="flex items-center space-x-3">
                                <span
                                    class="w-8 h-8 flex items-center justify-center rounded-full bg-primary text-white text-base">
                                    <i class="fa-brands fa-instagram"></i>
                                </span>
                                <div>
                                    <p class="text-sm font-semibold text-gray-800">Instagram</p>
                                    <p class="text-xs text-gray-500">@kampungkopi_camp</p>
                                </div>
                            </div>
                            <a href="{{ $socialMedia['instagram'] }}"
                                class="text-sm text-secondary font-medium hover:underline">Follow</a>
                        </li>
                        ...
                        <li class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-800">Youtube</p>
                                    <p class="text-xs text-gray-500">Kampung Kopi Camp</p>
                                </div>
                            </div>
