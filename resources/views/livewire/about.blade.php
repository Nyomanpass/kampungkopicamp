    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="grid grid-rows-2 gap-6">
        <div 
          ...
          <img src="/images/headerctapupuan.webp" alt="Labuan Sait Beach" class="w-full h-62 object-cover">
        </div>

        <div 
          class="relative rounded-xl overflow-hidden shadow-lg"
          data-aos="fade-right" data-aos-delay="400" data-aos-duration="1000">
          <img src="/images/tendapupuan.webp" alt="Conservation & Wildlife" class="w-full h-62 object-cover">
        </div>
      </div>
    </div>
  </div>
